...
function initFirestore(app) {
    ...
    return new firestore_1.Firestore(options);
}
/**
 ...
 */
function initFirestoreService(app) {
    var firestore = initFirestore(app);
...
exports.initFirestoreService = initFirestoreService;
