...
var FirebaseNamespace = /** @class */ (function () {
    ...
    /* istanbul ignore next */
    FirebaseNamespace.prototype.storage = function () {
        throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INTERNAL_ERROR, 'INTERNAL ASSERT FAILED: Firebase storage() service has not been registered.');
    };
    /* istanbul ignore next */
    FirebaseNamespace.prototype.firestore = function () {
        throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INTERNAL_ERROR, 'INTERNAL ASSERT FAILED: Firebase firestore() service has not been registered.');
    };
    /**
     * Initializes the FirebaseApp instance.
     *
