        ...
        function (
            ...
            setTimeout(() => {
                try {
                    ...
                    console.log(
                        'A problem for getting the IoT Lite @Context has been found.'
                    );
                    ...
                    setTimeout(() => {
                        if (allContexts[contextDefaultObj.$value]) {
                            localStorage.setItem(
                                DEFAULT_CONTEXT_ID,
                                allContexts[contextDefaultObj.$value].idcontexth
                            );
                        } else {
            ...
            setTimeout(() => {
                try {
                    ...
                    console.log(
                        'A problem for getting the IoT Lite @Graph has been found.'
                    );
                    console.log('Cause: Slow internet connection.\nDetails:\n', err);
                    console.log('A new attempt is being done right now.');
                    setTimeout(() => {
